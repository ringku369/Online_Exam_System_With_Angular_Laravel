...
@Component({
  selector: 'app-admin-usertransactionreport',
  templateUrl: './admin-usertransactionreport.component.html',
  styleUrls: ['./admin-usertransactionreport.component.scss']
})
export class AdminUsertransactionreportComponent implements OnInit {
  ...
  users:any = [];
  OnSubmitChild(){
    this.adminReportService.dateWiseSelfTransaction(this.form).subscribe(
      (response: any) => {
        this.users = response;
        //console.log(response);
        this.spinner.hide();
