...
@Component({
  selector: 'app-admin-aboutvc',
  templateUrl: './admin-aboutvc.component.html',
  styleUrls: ['./admin-aboutvc.component.scss']
})
export class AdminAboutvcComponent implements OnInit {
