...
import { AdminAboutvcRoutingModule } from './admin-aboutvc-routing.module';
...
@NgModule({
  declarations: [AdminAboutvcComponent],
  imports: [
    CommonModule,
    AdminAboutvcRoutingModule,
    SharedModule,
...
export class AdminAboutvcModule { }
