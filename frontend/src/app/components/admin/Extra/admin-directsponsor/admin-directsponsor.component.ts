...
@Component({
  selector: 'app-admin-directsponsor',
  templateUrl: './admin-directsponsor.component.html',
  styleUrls: ['./admin-directsponsor.component.scss']
})
export class AdminDirectsponsorComponent implements OnInit {
  ...
  submitForm():any {
    this.spinner.show();
    this.adminUserService.postDirectSponsor(this.form).subscribe(
      (response: any) => {
