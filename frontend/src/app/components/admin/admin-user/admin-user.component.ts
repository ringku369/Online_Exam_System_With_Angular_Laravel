...
export class AdminUserComponent implements OnInit {
  ...
  submitForm():any {
    ...
    this.spinner.show();
    this.adminUserService.createUser(this.form).subscribe(
      (response: any) => {
        //console.log(response);
  ...
  updateForm():any {
    console.log(this.form);
    this.spinner.show();
    this.adminUserService.updateUser(this.form).subscribe(
      (response: any) => {
        //console.log(response);
        this.form = {
          id: null,
  ...
  deleteForm():any {
    ...
    this.spinner.show();
    this.adminUserService.deleteUser(this.form.id).subscribe(
      (response: any) => {
        this.form.name = null;
        this.isUpdate = false;
        this.successMsg(response);
