...
@Component({
  selector: 'app-superadmin-usercountreport',
  templateUrl: './superadmin-usercountreport.component.html',
  styleUrls: ['./superadmin-usercountreport.component.scss']
})
export class SuperadminUsercountreportComponent implements OnInit {
  ...
  OnSubmitChild(){
    this.term = null;
    this.superadminReportService.dateWiseSelfDLUser(this.form).subscribe(
      (response: any) => {
        this.users = response;
