...
@Component({
  selector: 'app-superadmin-aboutvc',
  templateUrl: './superadmin-aboutvc.component.html',
  styleUrls: ['./superadmin-aboutvc.component.scss']
})
export class SuperadminAboutvcComponent implements OnInit {
