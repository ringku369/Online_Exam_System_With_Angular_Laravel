...
@Component({
  selector: 'app-superadmin-directsponsor',
  templateUrl: './superadmin-directsponsor.component.html',
  styleUrls: ['./superadmin-directsponsor.component.scss']
})
export class SuperadminDirectsponsorComponent implements OnInit {
  ...
  submitForm():any {
    this.spinner.show();
    this.superadminUserService.postDirectSponsor(this.form).subscribe(
      (response: any) => {
