...
import { SuperadminReportService } from 'src/app/services/superadmin/superadmin-report.service';
...
@Component({
  selector: 'app-superadmin-userblnupdatereport',
  templateUrl: './superadmin-userblnupdatereport.component.html',
  styleUrls: ['./superadmin-userblnupdatereport.component.scss']
})
export class SuperadminUserblnupdatereportComponent implements OnInit {
  ...
  constructor(
    ...
    private superadminReportService: SuperadminReportService,
  ...
  users:any = [];
  OnSubmitChild(){
    this.superadminReportService.dateWiseUserBlnUpdate(this.form).subscribe(
      (response: any) => {
  ...
  OnSubmitChild1(){
    this.superadminReportService.monthWiseGenerationUpdate(this.form).subscribe(
      (response: any) => {
        //this.users = response;
