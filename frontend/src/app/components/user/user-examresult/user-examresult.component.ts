...
@Component({
  selector: 'app-user-examresult',
  templateUrl: './user-examresult.component.html',
  styleUrls: ['./user-examresult.component.scss']
})
export class UserExamresultComponent implements OnInit {
  ...
  getExamresult(){
    this.spinner.show();
    this.userUserService.getExamresult().subscribe(
      (response: any) => {
