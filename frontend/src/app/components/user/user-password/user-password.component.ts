...
export class UserPasswordComponent implements OnInit {
  ...
  public users:any = [];
  getSelfProfile(){
    this.userUserService.getSelfProfile().subscribe(
      (response: any) => {
  ...
  onSubmit(): any {
    this.spinner.show();
    this.userUserService.putSelfPassword(this.form).subscribe(
      (response: any) => {
        //console.log(response);
  ...
  putSelfPasswordConfirmation(request):any {
    this.spinner.show();
    this.userUserService.putSelfPasswordConfirmation(request).subscribe(
      (response: any) => {
        //console.log(response);
        this.form = {
          current_password: null,
