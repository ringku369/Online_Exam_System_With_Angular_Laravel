...
@Component({
  selector: 'app-user-examstart',
  templateUrl: './user-examstart.component.html',
  styleUrls: ['./user-examstart.component.scss']
})
export class UserMappedqexamstartComponent implements OnInit {
  ...
  getActiveExam(){
    this.spinner.show();
    this.userUserService.getActiveExam().subscribe(
      (response: any) => {
...
// Cache area
  ...
  putCacheData(){
    this.userUserService.putCacheData(this.sessiondata).subscribe(
      (response: any) => {
        ////console.log(response);
      },
      (error: any) => {
  ...
  getCacheData(){
    this.userUserService.getCacheData().subscribe(
      (response: any) => {
        ////console.log(response);
      },
      (error: any) => {
  ...
  forgetCacheData(){
    this.userUserService.forgetCacheData(this.sessiondata).subscribe(
      (response: any) => {
        ////console.log(response);
      },
      (error: any) => {
...
getExamQuestionData(data:any){
  ////console.log(data);
  this.spinner.show();
  this.userUserService.getExamQuestionData(data).subscribe(
    (response: any) => {
      //console.log(response);
...
// Exam question  Data
  ...
  submitQuestionData(){
    ...
    this.userUserService.postExamQuestionData(this.form).subscribe(
      (response: any) => {
        ////console.log(response);
        this.examListArea = true;
  ...
  makeExamQuestionAnSheet(){
    ...
    this.userUserService.makeExamQuestionAnSheet(this.examReqData).subscribe(
      (response: any) => {
        //console.log(response);
        //this.examReqData = {};
        this.form = { examdata : [] };
  ...
  getExamAnsSheet(){
    ...
    this.userUserService.getExamAnsSheet(this.examReqData).subscribe(
      (response: any) => {
        //console.log(response);
  ...
  makeExamAnswerSheet(){
    ...
    this.userUserService.makeExamQuestionAnSheet(this.demodata).subscribe(
      (response: any) => {
        //console.log(response);
        //this.examReqData = {};
        this.form = { examdata : [] };
  ...
  deleteForm():any {
    ...
    this.spinner.show();
    this.userUserService.userExdata(this.form.id).subscribe(
      (response: any) => {
        this.examquestions = [];
        this.form = { examdata : [] };
        this.itemArray = [];
