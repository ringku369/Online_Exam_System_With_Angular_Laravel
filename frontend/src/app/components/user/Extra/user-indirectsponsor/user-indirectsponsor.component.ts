...
@Component({
  selector: 'app-user-indirectsponsor',
  templateUrl: './user-indirectsponsor.component.html',
  styleUrls: ['./user-indirectsponsor.component.scss']
})
export class UserIndirectsponsorComponent implements OnInit {
  ...
  submitForm():any {
    this.spinner.show();
    this.userUserService.postIndirectSponsor(this.form).subscribe(
      (response: any) => {
