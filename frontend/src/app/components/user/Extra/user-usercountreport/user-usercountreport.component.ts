...
@Component({
  selector: 'app-user-usercountreport',
  templateUrl: './user-usercountreport.component.html',
  styleUrls: ['./user-usercountreport.component.scss']
})
export class UserUsercountreportComponent implements OnInit {
  ...
  OnSubmitChild(){
    this.term = null;
    this.userReportService.dateWiseSelfDLUser(this.form).subscribe(
      (response: any) => {
        this.users = response;
