...
@Component({
  selector: 'app-user-usertransactionreport',
  templateUrl: './user-usertransactionreport.component.html',
  styleUrls: ['./user-usertransactionreport.component.scss']
})
export class UserUsertransactionreportComponent implements OnInit {
  ...
  users:any = [];
  OnSubmitChild(){
    this.userReportService.dateWiseSelfTransaction(this.form).subscribe(
      (response: any) => {
        this.users = response;
