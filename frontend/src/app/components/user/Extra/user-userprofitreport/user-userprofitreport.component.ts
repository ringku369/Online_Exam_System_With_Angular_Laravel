...
@Component({
  selector: 'app-user-userprofitreport',
  templateUrl: './user-userprofitreport.component.html',
  styleUrls: ['./user-userprofitreport.component.scss']
})
export class UserUserprofitreportComponent implements OnInit {
  ...
  OnSubmitChild(){
    this.sum = 0;
    this.userReportService.dateWiseSelfProfit(this.form).subscribe(
      (response: any) => {
        this.users = response;
