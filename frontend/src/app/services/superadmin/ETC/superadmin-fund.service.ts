...
export class SuperadminFundService {
  ...
  getAdminLinkUser(): any{
    return this.http.get(`${this.baseurl.geturl()}/superadmin/getAdminLinkUser`);
  }
  ...
  postFundTrToUser(request:any): any{
    return this.http.post(`${this.baseurl.geturl()}/superadmin/postFundTrToUser`,request);
  }
  
  postFundTrToUserConfirm(request:any): any{
    return this.http.post(`${this.baseurl.geturl()}/superadmin/postFundTrToUserConfirm`,request);
  }
  
  postFundTrToAdmin(request:any): any{
    return this.http.post(`${this.baseurl.geturl()}/superadmin/postFundTrToAdmin`,request);
  }
  
  postFundTrToAdminConfirm(request:any): any{
    return this.http.post(`${this.baseurl.geturl()}/superadmin/postFundTrToAdminConfirm`,request);
  }
